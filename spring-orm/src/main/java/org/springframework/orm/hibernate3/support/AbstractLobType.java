 ...
 * Retrieves the LobHandler to use from LocalSessionFactoryBean at springconfig time.
 *
...
public abstract class AbstractLobType implements UserType {
	...
	/**
	 * Constructor used by Hibernate: fetches springconfig-time LobHandler and
	 * springconfig-time JTA TransactionManager from LocalSessionFactoryBean.
