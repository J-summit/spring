...
public class LocalSessionFactoryBean extends AbstractSessionFactoryBean implements BeanClassLoaderAware {
	...
	/**
	 * Set the location of a single Hibernate XML springconfig file, for example as
	...
	/**
	 * Set the locations of multiple Hibernate XML springconfig files, for example as
	 ...
	 * Analogous to mapping entries in a Hibernate XML springconfig file.
	 * Alternative to the more generic setMappingLocations method.
	 * <p>Can be used to add to mappings from a Hibernate XML springconfig file,
	 ...
	 * <p>Can be used to override values in a Hibernate XML springconfig file,
	 ...
	 * Will be exposed at springconfig time for UserType implementations.
