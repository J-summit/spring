 ...
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/soap-ws-springconfig.xml")
 * public class SoapWebServiceTests extends AbstractWebTests {}
 *
 * &#064;ContextHierarchy(&#064;ContextConfiguration("/spring/rest-ws-springconfig.xml")
 ...
 * three application contexts will be loaded: one for {@code "/app-springconfig.xml"},
 * one for {@code "/user-springconfig.xml"}, and one for <code>{"/user-springconfig.xml",
 * "/order-springconfig.xml"}</code>. As with the previous example, the application
 * context loaded from {@code "/app-springconfig.xml"} will be set as the parent context
 * for the contexts loaded from {@code "/user-springconfig.xml"} and <code>{"/user-springconfig.xml",
 * "/order-springconfig.xml"}</code>.
 *
 * <pre class="code">
 * &#064;RunWith(SpringJUnit4ClassRunner.class)
 * &#064;ContextHierarchy({
 *     &#064;ContextConfiguration(name = "parent", locations = "/app-springconfig.xml"),
 *     &#064;ContextConfiguration(name = "child",  locations = "/user-springconfig.xml")
 * })
 * public class BaseTests {}
 * 
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/order-springconfig.xml")
 * )
 ...
 * only from {@code "/test-user-springconfig.xml"} and will have its parent set to the
 * context loaded from {@code "/app-springconfig.xml"}.
 *
 * <pre class="code">
 * &#064;RunWith(SpringJUnit4ClassRunner.class)
 * &#064;ContextHierarchy({
 ...
 * 
 * &#064;ContextHierarchy(
 *     &#064;ContextConfiguration(name = "child",  locations = "/test-user-springconfig.xml", inheritLocations=false)
 * )
 * public class ExtendedTests extends BaseTests {}</pre>
 *
 * @author Sam Brannen
