 ...
 * springconfig locations String array describing the Spring resource descriptors
 ...
 * method and provide the desired springconfig files. For alternative configuration
 * options, see {@link #getConfigPath()} and {@link #getConfigPaths()}.
 * </p>
 * <p>
 * If you don't want to load a standard context from an array of springconfig
...
public abstract class AbstractSingleSpringContextTests extends AbstractSpringContextTests {
	...
	/**
	 * Return a key for this context. Default is the springconfig location array as
	...
	/**
	 * Load a Spring ApplicationContext from the given springconfig locations.
	 ...
	 * @param locations the springconfig locations (as Spring resource locations,
	 ...
	 * context from the specified springconfig {@code locations} through the configured
	 ...
	 * springconfig files, unless they override {@link #contextKey()} and
	 ...
	 * springconfig location path prefixed with "classpath:" with behave the same as a
	 * plain path, but a springconfig location such as
	 * "file:/some/path/path/location/appContext.xml" will be treated as a
	 * filesystem location.
	 * <p>The default implementation builds springconfig locations for the springconfig paths
	 * specified through {@link #getConfigPaths()}.
	 * @return an array of springconfig locations
	 * @see #getConfigPaths()
	...
	/**
	 * Subclasses can override this method to return paths to their springconfig
	 ...
	 * <p>The default implementation builds an array for the springconfig path specified
	...
	/**
	 * Subclasses can override this method to return a single path to a springconfig
