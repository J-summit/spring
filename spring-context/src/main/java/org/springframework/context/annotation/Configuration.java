 ...
 * {@code
 * <beans>
 *    <context:annotation-springconfig/>
 *    <bean class="com.acme.AppConfig"/>
 * </beans>}</pre>
 *
 * In the example above, {@code <context:annotation-springconfig/>} is required in order to
 ...
 * <pre class="code">
 * &#064;Configuration
 * &#064;ImportResource("classpath:/com/acme/database-springconfig.xml")
 * public class AppConfig {
