...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
	...
	/**
	 * Specify whether to register annotation springconfig post-processors.
	...
	public int scan(String... basePackages) {
		...
		// Register annotation springconfig processors, if necessary.
	 ...
	 * <p>This method does <i>not</i> register an annotation springconfig processor
