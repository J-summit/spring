 ...
 * all defined tools in the specified scopes. If no springconfig location is
...
public class VelocityToolboxView extends VelocityView {
	...
	/**
	 * Set a Velocity Toolbox springconfig location, for example "/WEB-INF/toolbox.xml",
	 * to automatically load a Velocity Tools toolbox definition file and expose
	 * all defined tools in the specified scopes. If no springconfig location is
	 * specified, no toolbox will be loaded and exposed.
	...
	/**
	 * Return the Velocity Toolbox springconfig location, if any.
	 */
