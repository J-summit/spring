...
/**
 * Test fixture for the configuration in mvc-springconfig-annotation-driven.xml.
...
public class AnnotationDrivenBeanDefinitionParserTests {
	...
	public void testMessageCodesResolver() {
		loadBeanDefinitions("mvc-springconfig-message-codes-resolver.xml");
	...
	public void testPathMatchingConfiguration() {
		loadBeanDefinitions("mvc-springconfig-path-matching.xml");
	...
	public void testMessageConverters() {
		loadBeanDefinitions("mvc-springconfig-message-converters.xml");
	...
	public void testMessageConvertersWithoutDefaultRegistrations() {
		loadBeanDefinitions("mvc-springconfig-message-converters-defaults-off.xml");
	...
	public void testArgumentResolvers() {
		loadBeanDefinitions("mvc-springconfig-argument-resolvers.xml");
		RequestMappingHandlerAdapter adapter = appContext.getBean(RequestMappingHandlerAdapter.class);
		assertNotNull(adapter);
	...
	public void testReturnValueHandlers() {
		loadBeanDefinitions("mvc-springconfig-return-value-handlers.xml");
		RequestMappingHandlerAdapter adapter = appContext.getBean(RequestMappingHandlerAdapter.class);
		assertNotNull(adapter);
	...
	public void beanNameUrlHandlerMapping() {
		loadBeanDefinitions("mvc-springconfig.xml");
