...
public class SchedulerFactoryBean extends SchedulerAccessor implements FactoryBean<Scheduler>,
	...
	/**
	 * Set the location of the Quartz properties springconfig file, for example
	 ...
	 * <p>Can be used to override values in a Quartz properties springconfig file,
	...
	private void initSchedulerFactory(SchedulerFactory schedulerFactory) throws SchedulerException, IOException {
		...
		if (this.configLocation != null) {
			if (logger.isInfoEnabled()) {
				logger.info("Loading Quartz springconfig from [" + this.configLocation + "]");
			}
