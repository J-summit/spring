...
public class VelocityEngineFactory {
	...
	/**
	 * Set the location of the Velocity springconfig file.
	 ...
	 * Can be used to override values in a Velocity springconfig file,
	 ...
	 * @throws IOException if the springconfig file wasn't found
	...
	public VelocityEngine createVelocityEngine() throws IOException, VelocityException {
		...
		// Load springconfig file if set.
		if (this.configLocation != null) {
			if (logger.isInfoEnabled()) {
				logger.info("Loading Velocity springconfig from [" + this.configLocation + "]");
			}
	 ...
	 * @return the VelocityEngine instance
	 * @throws IOException if a springconfig file wasn't found
	 * @throws VelocityException on Velocity initialization failure
	 * @see #createVelocityEngine()
	 */
