 ...
 * instance (independent or shared), configured from a specified springconfig location.
 *
 * <p>If no springconfig location is specified, a CacheManager will be configured from
 ...
 * also necessary for loading EhCache configuration from a non-default springconfig location.
 *
...
public class EhCacheManagerFactoryBean implements FactoryBean<CacheManager>, InitializingBean, DisposableBean {
	...
	/**
	 * Set the location of the EhCache springconfig file. A typical value is "/WEB-INF/ehcache.xml".
