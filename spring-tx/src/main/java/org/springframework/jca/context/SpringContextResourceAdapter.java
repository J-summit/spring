 ...
 *		 &lt;springconfig-property&gt;
 *			 &lt;springconfig-property-name&gt;ContextConfigLocation&lt;/springconfig-property-name&gt;
 *			 &lt;springconfig-property-type&gt;java.lang.String&lt;/springconfig-property-type&gt;
 *			 &lt;springconfig-property-value&gt;META-INF/applicationContext.xml&lt;/springconfig-property-value&gt;
 *		 &lt;/springconfig-property&gt;
 *	 &lt;/resourceadapter&gt;
 * &lt;/connector&gt;</pre>
 *
 * Note that "META-INF/applicationContext.xml" is the default context springconfig
 * location, so it doesn't have to specified unless you intend to specify
 * different/additional springconfig files. So in the default case, you may remove
 * the entire {@code springconfig-property} section above.
 *
...
public class SpringContextResourceAdapter implements ResourceAdapter {
	 ...
	 * multiple context springconfig paths in a single String value.
	 * @see #setContextConfigLocation
	 */
	 ...
	 * <p>This can be specified as "ContextConfigLocation" springconfig
	...
	protected ConfigurableApplicationContext createApplicationContext(BootstrapContext bootstrapContext) {
		...
		// Extract individual springconfig locations.
	 ...
	 * @param configLocations the parsed springconfig locations
	 * @see #setContextConfigLocation
	 */
