 ...
 * {@code &lt;aop:springconfig&gt;} tag. A {@code springconfig} tag can include nested
...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	 ...
	 * '{@code springconfig}', '{@code spring-configured}', '{@code aspectj-autoproxy}'
	 * and '{@code scoped-proxy}' tags.
	 */
	public void init() {
		// In 2.0 XSD as well as in 2.1 XSD.
		registerBeanDefinitionParser("springconfig", new ConfigBeanDefinitionParser());
