 ...
 * Location of the log4j springconfig file; either a "classpath:" location (e.g.
 ...
 * Interval between springconfig file refresh checks, in milliseconds. If not specified,
 ...
 * for "${key}" substitutions within log file locations in the log4j springconfig file,
 * allowing for log file paths relative to the web application root directory.
 * The default system property key is "webapp.root", to be used in a log4j springconfig
...
public abstract class Log4jWebConfigurer {
	...
	/** Parameter specifying the location of the log4j springconfig file */
	public static final String CONFIG_LOCATION_PARAM = "log4jConfigLocation";

	/** Parameter specifying the refresh interval for checking the log4j springconfig file */
	...
	public static void initLogging(ServletContext servletContext) {
		...
		// Only perform custom log4j initialization in case of a springconfig file.
