 ...
 * for registering classes one by one (specifying class names as springconfig location) as well
 * as for classpath scanning (specifying base packages as springconfig location).
 *
			...
			for (String configLocation : configLocations) {
				try {
					...
					if (logger.isDebugEnabled()) {
						logger.debug("Could not load class for springconfig location [" + configLocation +
