...
public class ContextLoader {
	 ...
	 * springconfig location for the root context, falling back to the implementation's
	 * default otherwise.
	 ...
	 * ContextLoader after springconfig locations have been supplied to the context
