 ...
 * regard to springconfig location precedence, overriding and defaulting in programmatic
...
public class Spr8510Tests {
	...
	/**
	 * If context springconfig locations have been specified neither against the application
