...
public interface ConfigurablePortletApplicationContext
	...
	/**
	 * Set the springconfig locations for this portlet application context in init-param style,
	...
	/**
	 * Set the springconfig locations for this portlet application context.
	 * <p>If not set, the implementation is supposed to use a default for the
	 * given namespace.
	 */
	...
	/**
	 * Return the springconfig locations for this web application context,
