...
public class StandardPortletEnvironment extends StandardEnvironment {
	...
	/** Portlet springconfig init parameters property source name: {@value} */
	 ...
	 * instances acting as placeholders with real portlet context/springconfig property sources
