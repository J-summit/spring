 ...
 *
 * <p>The springconfig location defaults can be overridden via the "contextConfigLocation"
 ...
 *
 * <p>Note: In case of multiple springconfig locations, later bean definitions will
...
public class XmlPortletApplicationContext extends AbstractRefreshablePortletApplicationContext {
	...
	/** Default springconfig location for the root context */
	public static final String DEFAULT_CONFIG_LOCATION = "/WEB-INF/applicationContext.xml";

	/** Default prefix for building a springconfig location for a namespace */
	public static final String DEFAULT_CONFIG_LOCATION_PREFIX = "/WEB-INF/";

	/** Default suffix for building a springconfig location for a namespace */
