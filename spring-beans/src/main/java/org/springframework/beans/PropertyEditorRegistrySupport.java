...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	...
	/**
	 * Activate springconfig value editors which are only intended for configuration purposes,
	...
	private void createDefaultEditors() {
		...
		// Only register springconfig value editors if explicitly requested.
