 ...
 *
 * <p>The proxy is defined in the Struts springconfig file, specifying this
 ...
 * as the {@code Action} type in your struts-springconfig file (for example to
 * be able to generate your Struts springconfig file with XDoclet) consider using the
